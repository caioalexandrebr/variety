...
<head>
    <meta charset="UTF-8">
    <title>Variety Purple - Caio Alexandre</title>
        ...
        <aside>
            <div class="div_work_box">
                <div class="div_work_box_ico">
                    <img src="/variety/img/purple/work-ico1.jpg" height="68" width="68">
                </div>
            ...
            <div class="div_work_box" style="margin-left: 100px;">
                <div class="div_work_box_ico">
                    <img src="/variety/img/purple/work-ico2.jpg" height="68" width="68">
                </div>
            ...
            <div class="div_work_box" style="float: right;">
                <div class="div_work_box_ico">
                    <img src="/variety/img/purple/work-ico3.jpg" height="68" width="68">
                </div>
                <h1>Finalize</h1>
                <h2>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren.</h2>
            </div>
    ...
    <div class="div_article">
        <div class="div_article_left">
            <article>
                ...
                <div class="article-img"><img src="/variety/img/purple/figure-img1.jpg"></div>
            </article>
            <article>
                <a href="#" title="Lorem ipsum dolor sit" class="article-search"></a>
                <div class="article-ft">
                ...
                <div class="article-img"><img src="/variety/img/purple/figure-img2.jpg"></div>
            </article>
        </div>
        <div class="div_article_right">
            <article>
                ...
                <div class="article-img"><img src="/variety/img/purple/figure-img3.jpg"></div>
            </article>
            <article>
                <a href="#" title="Lorem ipsum dolor sit" class="article-search"></a>
                <div class="article-ft">
                ...
                <div class="article-img"><img src="/variety/img/purple/figure-img4.jpg"></div>
            </article>
        </div>
    </div>
    ...
    <div class="div_footer_center">
        <div class="div_footer_center_sociais">
            <div class="div_footer_center_sociais_area">
                <div id="dribbble"><a href="#"><img src="/variety/img/purple/dribbble.png" height="100" width="100"></a></div>
                <div id="twitter"><a href="#"><img src="/variety/img/purple/twitter.png" height="100" width="100"></a></div>
                <div id="facebook"><a href="#"><img src="/variety/img/purple/facebook.png" height="100" width="100"></a></div>
            </div>
        </div>
